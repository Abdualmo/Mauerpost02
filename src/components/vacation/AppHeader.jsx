...
export default function AppHeader() {
  ...
  return (
    <>
      ...
      {/* Rendered as a sibling of <header>, not a child, so that the
          backdrop-filter on the header does not become the containing
          block of the panel's position:fixed backdrop. */}
      {settingsOpen && (
